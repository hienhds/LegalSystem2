...
export default function FindLawyer() {
  ...
  const fetchBarAssociations = async () => {
    try {
      // TODO: Implement /api/bar-association endpoint
  ...
  const fetchStats = async () => {
    try {
      // TODO: Implement /api/lawyers/stats endpoint
    ...
    <Layout showFooter={true}>
      ...
      >
        <div className="flex flex-col gap-4 text-center">
          <h1 className="font-serif text-white text-1xl sm:text-2xl md:text-5xl font-bold">
            Tìm Luật Sư Uy Tín
          </h1>
          <h2 className="text-white/90 text-sm font-normal leading-normal md:text-base">
            {stats.totalLawyers || 0} Luật sư | ⭐{" "}
            {stats.averageRating?.toFixed(1) || "0.0"}/5 | ✅{" "}
            {Math.round(stats.satisfactionRate || 0)}% Hài lòng
          </h2>
        </div>
        <form
          onSubmit={handleSearch}
          className="mt-8 w-full max-w-[600px] shadow-lg rounded-full"
        >
                ...
                <div className="border-b border-slate-200 dark:border-slate-800 py-6">
                  ...
                  >
                    ...
                    {barAssociations.map((bar) => (
                      <option
                        key={bar.barAssociationId}
                        value={bar.barAssociationId}
                      >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          <div>
                            <h3 className="text-xl font-bold text-blue-600 font-serif">
                        ...
                        <div className="text-sm text-slate-500 dark:text-slate-400 mt-3 space-y-1.5">
                          ...
                          <p className="flex items-center gap-2">
                            ...
                            <span>
                              {lawyer.officeAddress || "Chưa cập nhật"}
                            </span>
                          </p>
                          <p className="flex items-center gap-2">
                            <span className="material-symbols-outlined !text-base">
                            ...
                            <span>
                              {lawyer.yearsOfExp || 0} năm kinh nghiệm
                            </span>
                          </p>
                        </div>
                ...
                {pagination.totalPages > 1 && (
                  ...
                  >
                    ...
                    {pagination.totalPages > 5 && (
                      <span className="inline-flex items-center justify-center size-10 text-slate-500 mx-1">
                        ...
                      </span>
                    )}
